...
/*	if (cmpState != 0)
	{
		printf("minion_play Pre: currentplayer: %d, choice1: %d, choic2: %d, handCount: %d, deckCount: %d, discardCount: %d, numActions: %d, coins: %d, playedCardCount: %d\n",
